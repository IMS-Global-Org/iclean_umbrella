{application,iclean,
             [{applications,[kernel,stdlib,elixir,logger,runtime_tools,jason,
              ...
              {description,"iclean"},
              {modules,['Elixir.Employment.Search',
                        'Elixir.Employment.Validate','Elixir.IClean',
                        'Elixir.IClean.Address','Elixir.IClean.Application',
                        'Elixir.IClean.DataCase','Elixir.IClean.Employee',
                        'Elixir.IClean.Employer','Elixir.IClean.Employment',
                        'Elixir.IClean.Equipment','Elixir.IClean.Material',
                        'Elixir.IClean.Repo','Elixir.IClean.Users.User',
                        'Elixir.IClean.Warning',
